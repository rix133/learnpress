...
<div class="learn-press-form-login learn-press-form">
    ...
    <p v-show="getMessage()" class="learn-press-message" :class="[error ? 'error' : 'success']" v-html="getMessage()"></p>
    ...
    <form name="learn-press-login" method="post" action="">
        ...
        <p>
            ...
            <input type="hidden" name="api" value="user/login">
            <button type="submit"><?php _e( 'Login', 'learnpress' ); ?></button>
<!--            <a href="" @click="_showForm($event, 'register')">--><?php //esc_html_e( 'Register', 'learnpress' ); ?><!--</a>-->
        </p>
        <p>
